...
function buildGeminiPrompt(args: {
  ...
  if (isHardQuizWithPrize(args.typeName)) {
    ...
    return [
      ...
      "Keep hard_quiz.question around 45-60 Vietnamese words, maximum 70 words or 380 characters.",
      ...
      "- Hard Quiz question image limit: write the visible question in 45-60 Vietnamese words, maximum 70 words or 380 characters.",
      ...
      JSON.stringify({
        ...
        hard_quiz: {
          question: "Hard Quiz question concise 45-60 Vietnamese words, maximum 70 words/380 characters, application-level, may require about 10 lines to solve. Formulas must use $x^2+1=0$ format.",
