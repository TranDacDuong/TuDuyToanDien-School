(function () {
  ...
  function normalizeStaticGameText() {
    ...
    if (backBtn) { backBtn.innerHTML = "&larr;"; backBtn.classList.add("icon-btn"); backBtn.title = "Quay l&#7841;i"; backBtn.setAttribute("aria-label", "Quay l&#7841;i"); }
  ...
  function ensureSubjectSelectModal() {
    ...
    modal.innerHTML = `
      <div class="modal-card" style="width:min(720px,100%)">
        <div class="mh">
          <h2>Chọn môn</h2>
          <button class="btn btn-outline icon-btn" type="button" onclick="closeGameSubjectSelectModal()" title="&#272;&#243;ng" aria-label="&#272;&#243;ng">&times;</button>
        </div>
